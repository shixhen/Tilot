...
import { LoaderCircle, SquarePen, Terminal } from "lucide-react";
  ...
  return <SidebarProvider className="h-dvh min-h-0 flex-col overflow-hidden">
    ...
    <SidebarInset className="min-h-0 min-w-0 overflow-hidden">
      ...
      <div ref={scroll} className="min-h-0 flex-1 overflow-y-auto" onScroll={(event) => {
        ...
        <div className="mx-auto grid w-full min-w-0 max-w-3xl grid-cols-1 gap-10 px-6 py-8">
      ...
      <div id="workspace-composer" className="mx-auto grid w-full min-w-0 max-w-3xl shrink-0 grid-cols-1 gap-3 px-4 pb-4 pt-2 sm:px-6">
